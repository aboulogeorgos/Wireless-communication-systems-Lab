...
# Title: Psk Modulation Example
# Generated: Mon Aug 19 19:00:15 2019
##################################################
...
class PSK_modulation_example(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Psk Modulation Example")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Psk Modulation Example")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "PSK_modulation_example")
...
def main(top_block_cls=PSK_modulation_example, options=None):
