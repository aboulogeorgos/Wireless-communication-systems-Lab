...
# Generated: Wed Aug 14 07:13:52 2019
##################################################
...
class psk_modulation_demodulation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "psk_modulation_demodulation")
...
def main(top_block_cls=psk_modulation_demodulation, options=None):
