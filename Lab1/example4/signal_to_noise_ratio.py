...
# Generated: Wed Jul 31 17:29:13 2019
##################################################
...
class signal_to_noise_ratio(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Signal To Noise Ratio")
        ...
        self.settings = Qt.QSettings("GNU Radio", "signal_to_noise_ratio")
...
def main(top_block_cls=signal_to_noise_ratio, options=None):
