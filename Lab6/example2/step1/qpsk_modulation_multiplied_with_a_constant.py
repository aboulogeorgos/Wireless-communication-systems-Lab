...
# Title: Qpsk Modulation Multiplied With A Constant
# Author: Alexandros-Apostolos A. Boulogeorgos
# Generated: Mon Aug 12 10:33:01 2019
##################################################
...
class qpsk_modulation_multiplied_with_a_constant(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Qpsk Modulation Multiplied With A Constant")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Qpsk Modulation Multiplied With A Constant")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "qpsk_modulation_multiplied_with_a_constant")
        ...
        self.qtgui_time_sink_x_0_0 = qtgui.time_sink_c(
        	1024, #size
        	samp_rate, #samp_rate
        	'QT GUI Plot: Before multiplication', #name
        	1 #number of inputs
        )
        ...
        self.qtgui_time_sink_x_0 = qtgui.time_sink_c(
        	1024, #size
        	samp_rate, #samp_rate
        	'QT GUI Plot: After multiplication', #name
        	1 #number of inputs
        )
        ...
        self.connect((self.digital_psk_mod_0, 0), (self.qtgui_const_sink_x_0_0, 0))    
        self.connect((self.digital_psk_mod_0, 0), (self.qtgui_freq_sink_x_0_0, 0))    
...
def main(top_block_cls=qpsk_modulation_multiplied_with_a_constant, options=None):
