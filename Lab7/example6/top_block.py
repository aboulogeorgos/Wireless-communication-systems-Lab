...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "rtl_sdr_example")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("rtl_sdr_example")
        try:
        ...
        # Blocks
        ##################################################
        self._rf_gain_range = Range(0, 20, 1, 10, 200)
        ...
        self._f0_range = Range(200000, 1000000000, 1000, 800000, 200)
        ...
        self._bw_range = Range(0, 10000, 1, 0, 200)
        ...
        self.rtlsdr_source_0.set_center_freq(f0, 0)
        ...
        self.top_grid_layout.addWidget(self._qtgui_waterfall_sink_x_0_win, 2,2,1,1)
    ...
    def set_f0(self, f0):
        self.f0 = f0
        self.rtlsdr_source_0.set_center_freq(self.f0, 0)
