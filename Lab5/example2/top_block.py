...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        for label in self._clipping_labels: self._clipping_combo_box.addItem(label)
        self._clipping_callback = lambda i: Qt.QMetaObject.invokeMethod(self._clipping_combo_box, "setCurrentIndex", Qt.Q_ARG("int", self._clipping_options.index(i)))
        ...
        widths = [2, 2, 1, 1, 1,
                  1, 1, 1, 1, 1]
        colors = ["blue", "green", "cyan", "cyan", "cyan",
        ...
        self.analog_sig_source_x_1_0 = analog.sig_source_f(samp_rate, analog.GR_CONST_WAVE, 0, -clipping, 0)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_CONST_WAVE, 0, clipping, 0)
        ...
        self.connect((self.analog_rail_ff_0, 0), (self.qtgui_histogram_sink_x_0, 0))    
    ...
    def set_clipping(self, clipping):
        ...
        self._clipping_callback(self.clipping)
        self.qtgui_time_sink_x_0.set_y_axis(-1 - self.clipping, 1 + self.clipping)
        self.qtgui_histogram_sink_x_0.set_x_axis(-1 - self.clipping, 1 + self.clipping)
        self.analog_sig_source_x_1_0.set_amplitude(-self.clipping)
        self.analog_sig_source_x_1.set_amplitude(self.clipping)
        self.analog_rail_ff_0.set_lo(-self.clipping)
        self.analog_rail_ff_0.set_hi(self.clipping)
