...
# Generated: Tue Aug 13 07:30:29 2019
##################################################
...
class high_pass_filter(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.taps = taps = firdes.high_pass_2(1, 1, 0.4, 0.2, 80, firdes.WIN_BLACKMAN_hARRIS)
...
def main(top_block_cls=high_pass_filter, options=None):
