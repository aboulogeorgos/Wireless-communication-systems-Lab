...
class band_pass_filter_example(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Band_pass_filter")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Band_pass_filter")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "band_pass_filter_example")
        self.restoreGeometry(self.settings.value("geometry").toByteArray())

        ##################################################
        # Variables
        ##################################################
        self.taps = taps = firdes.complex_band_pass_2(1, 1, 0.1, 0.4, 0.01, 80, firdes.WIN_BLACKMAN_hARRIS)
...
def main(top_block_cls=band_pass_filter_example, options=None):
