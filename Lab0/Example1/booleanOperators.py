...
class booleanOperators(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "XOR")
        ...
        self.settings = Qt.QSettings("GNU Radio", "booleanOperators")
        ...
        self.connect((self.analog_random_source_x_0_0, 0), (self.blocks_xor_xx_0, 1))    
        ...
        self.connect((self.blocks_xor_xx_0, 0), (self.blocks_throttle_0, 0))    
...
def main(top_block_cls=booleanOperators, options=None):
